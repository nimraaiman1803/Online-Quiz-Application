...
public class Quiz extends JFrame implements ActionListener
{
	...
	public Quiz(String name)
	{
		...
		ImageIcon i1 = new ImageIcon("E:/proj/Quiz Application/icons/quiz.jpg");
	...
	public void paint(Graphics g)
	{
		...
		else if(timer < 0)
		{
			...
			if(count == 9)
			{
				if(grpoptns.getSelection() == null)
				{
					user_ans[count][0] = "";
				}
				else
				{
					user_ans[count][0] = grpoptns.getSelection().getActionCommand();
	...
	{
		qno.setText("" + (cnt + 1) + " .");
		q.setText(questions[cnt][0]);
		
		opt1.setText(questions[cnt][1]);
		opt1.setActionCommand(questions[cnt][1]);
		
		opt2.setText(questions[cnt][2]);
		opt2.setActionCommand(questions[cnt][2]);
		
		opt3.setText(questions[cnt][3]);
		opt3.setActionCommand(questions[cnt][3]);
		
		opt4.setActionCommand(questions[cnt][4]);
		opt4.setText(questions[cnt][4]);
		
		grpoptns.clearSelection();
	}
